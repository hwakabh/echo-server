...
* **deps:** update dependency rules_cc to v0.2.8 ([3f16979](https://github.com/hwakabh/echo-server/commit/3f16979095811a7bb2f8e4a78f0012acb26bfb4c))
* **deps:** update dependency rules_cc to v0.2.8 ([da365de](https://github.com/hwakabh/echo-server/commit/da365dedd67b1c8c0cd6b739eec4cfc4dba37a07))

## [0.4.11](https://github.com/hwakabh/echo-server/compare/v0.4.10...v0.4.11) (2025-09-09)


### Miscellaneous Chores

* **deps:** update dependency rules_cc to v0.2.4 ([d67acf8](https://github.com/hwakabh/echo-server/commit/d67acf8a7d9f9c35b16831230840353c9298c797))
* **deps:** update dependency rules_cc to v0.2.4 ([b79788c](https://github.com/hwakabh/echo-server/commit/b79788c1c79440d986e7d12fd4b0dbea9cbfc186))
...
* **deps:** update dependency rules_cc to v0.2.1 ([9d1c277](https://github.com/hwakabh/echo-server/commit/9d1c277895c68559b56286e3fca15884b9b3dea0))
* **deps:** update dependency rules_cc to v0.2.1 ([7318db7](https://github.com/hwakabh/echo-server/commit/7318db7abc0ca450fdfa69e6e7b400052b4fe97f))
...
* **deps:** update dependency rules_cc to v0.1.4 ([6d8889a](https://github.com/hwakabh/echo-server/commit/6d8889a8ad23b94e6d9f03d631ef845e163ed3af))
* **deps:** update dependency rules_cc to v0.1.4 ([5d3e71e](https://github.com/hwakabh/echo-server/commit/5d3e71e88e832392d127de59e3e6eb92281e99cb))
...
* **deps:** update hwakabh/semantic-issue-action action to v0.5.8 ([c347dd0](https://github.com/hwakabh/echo-server/commit/c347dd07e7242736951dcd87d32dd3b3bb4f5ffc))
* **deps:** update hwakabh/semantic-issue-action action to v0.5.8 ([973ab9c](https://github.com/hwakabh/echo-server/commit/973ab9c1580385d72e6215a081e3c98afb073c09))

## [0.4.1](https://github.com/hwakabh/echo-server/compare/v0.4.0...v0.4.1) (2025-05-06)


### Miscellaneous Chores

* **deps:** update hwakabh/semantic-issue-action action to v0.5.6 ([45e60fe](https://github.com/hwakabh/echo-server/commit/45e60febdb89db2f252838d17f37ce7d673eac88))
...
* **deps:** update hwakabh/semantic-issue-action action to v0.5.5 ([ff89555](https://github.com/hwakabh/echo-server/commit/ff895553be94aa89e05403fe84f506851f6063fb))
* **deps:** update hwakabh/semantic-issue-action action to v0.5.5 ([bda9499](https://github.com/hwakabh/echo-server/commit/bda94996a5867571ea5e0f1e7d341053bae9bf0b))
